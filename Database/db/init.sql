...
INSERT INTO inventario(Id, Nombre, PrecioVenta, Categoria, Distribuidor, Stock, PrecioCompra, Detalle) VALUES (default, 'Coca-Cola', 1000, 'Bebidas', 'Coca-Cola Company', 2, 900, 'bebida');
INSERT INTO inventario(Id, Nombre, PrecioVenta, Categoria, Distribuidor, Stock, PrecioCompra, Detalle) VALUES (default, 'Pepsi', 1100, 'Bebidas', 'CCU', 3, 900, 'bebida');
INSERT INTO inventario(Id, Nombre, PrecioVenta, Categoria, Distribuidor, Stock, PrecioCompra, Detalle) VALUES (default, 'Escudo', 1900, 'cerveza', 'CCU', 1, 500, 'cerveza excelente');
INSERT INTO inventario(Id, Nombre, PrecioVenta, Categoria, Distribuidor, Stock, PrecioCompra, Detalle) VALUES (default, 'Papas Lays', 1000, 'Snacks', 'EverCrisp', 12, 700, 'bebida');
